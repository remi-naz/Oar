...
@Suppress("LongMethod")
fun buildOarEntryProvider(navigator: OarNavigator) = entryProvider<NavKey> {
    onboardingEntries(navigator)
    dashboardEntries(navigator)
    transactionEntries(navigator)
    folderEntries(navigator)
    tagEntries(navigator)
    scheduleEntries(navigator)
...
// region Transactions
@Suppress("LongMethod")
fun EntryProviderScope<NavKey>.transactionEntries(navigator: OarNavigator) {
